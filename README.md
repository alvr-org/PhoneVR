...
* Currently only **[ALVR v20.2.1](https://github.com/alvr-org/ALVR/releases/tag/v20.2.1)** (latest stable) is supported by PhoneVR.
  * Older version - PhoneVR v1.0.0-beta -> ALVR v20.1.0
