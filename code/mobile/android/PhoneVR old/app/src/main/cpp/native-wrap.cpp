...
//////////////////////////////////////////// drawing //////////////////////////////////////////////
FUNC(jint, InitSystem)(JNIEnv *, jclass, jint x, jint y, jint resMul, jfloat offFov, jboolean isDD, jboolean warp, jboolean debug) {
    ...
    return PVRInitSystem(maxWidth, maxHeight, offFov, isDD, warp, debug);
}
